...
.const
	...
	lit1	SWORD 2
	lit2	BYTE "Смена логина проведена успешно!", 0
	lit3	BYTE "Ваш новый логин: ", 0
	lit4	BYTE "6 в степени 3 равно ", 0
	lit5	SWORD 6
	lit6	SWORD 3
	...
	lit14	SWORD 10
	lit15	SWORD 100
	lit16	BYTE "Квадратный корень из 9 равен 4? - ", 0
	lit17	SWORD 9
	lit18	SWORD 4
	lit19	BYTE "Да", 0
	lit20	BYTE "Нет", 0
