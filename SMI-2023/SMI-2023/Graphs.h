...
#define GRAPH_LINE_LITERAL 3,\
	...
	FST::NODE(157, \
			...
			FST::RELATION('Q', 1), FST::RELATION('R', 1), FST::RELATION('S', 1), FST::RELATION('T', 1),\
			FST::RELATION('U', 1), FST::RELATION('V', 1), FST::RELATION('W', 1), FST::RELATION('X', 1),\
			FST::RELATION('Y', 1), FST::RELATION('Z', 1), FST::RELATION('à', 1), FST::RELATION('á', 1), \
			FST::RELATION('â', 1), FST::RELATION('ã', 1), FST::RELATION('ä', 1), FST::RELATION('å', 1),	\
			FST::RELATION('¸', 1), FST::RELATION('æ', 1), FST::RELATION('ç', 1), FST::RELATION('è', 1),	\
			FST::RELATION('é', 1), FST::RELATION('ê', 1), FST::RELATION('ë', 1), FST::RELATION('ì', 1),	\
			FST::RELATION('í', 1), FST::RELATION('î', 1), FST::RELATION('ï', 1), FST::RELATION('ð', 1),	\
			FST::RELATION('ñ', 1), FST::RELATION('ò', 1), FST::RELATION('ó', 1), FST::RELATION('ô', 1),	\
			FST::RELATION('õ', 1), FST::RELATION('ö', 1), FST::RELATION('÷', 1), FST::RELATION('ø', 1),	\
			FST::RELATION('ù', 1), FST::RELATION('ü', 1), FST::RELATION('ú', 1), FST::RELATION('û', 1),	\
			FST::RELATION('ý', 1), FST::RELATION('þ', 1), FST::RELATION('ÿ', 1), FST::RELATION('À', 1), \
			FST::RELATION('Á', 1), FST::RELATION('Â', 1), FST::RELATION('Ã', 1), FST::RELATION('Ä', 1), \
			FST::RELATION('Å', 1), FST::RELATION('¨', 1), FST::RELATION('Æ', 1), FST::RELATION('Ç', 1), \
			...
			FST::RELATION('Ø', 1), FST::RELATION('Ù', 1), FST::RELATION('Ü', 1), FST::RELATION('Ú', 1), \
			FST::RELATION('Û', 1), FST::RELATION('Ý', 1), FST::RELATION('Þ', 1), FST::RELATION('ß', 1),	\
